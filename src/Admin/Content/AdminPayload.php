...
use Cmf\Foundation\ApplicationInfoProvider;
...
class AdminPayload
{
    ...
    public function __invoke(Document $document, Request $request)
    {
        ...
        $document->payload['displayNameDrivers'] = array_keys($this->container->make('cmf.user.display_name.supported_drivers'));
        $document->payload['slugDrivers'] = array_map(function ($resourceDrivers) {
            return array_keys($resourceDrivers);
        }, $this->container->make('cmf.http.slugDrivers'));
        ...
        /**
         * Used in the admin user list. Implemented as this as it matches the API in cmf/statistics.
         * If cmf/statistics ext is enabled, it will override this data with its own stats.
         *
