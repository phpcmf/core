...
class QueueServiceProvider extends AbstractServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->container->singleton(Factory::class, function (Container $container) {
            return new QueueFactory(function () use ($container) {
                return $container->make('cmf.queue.connection');
            });
        });

        // Extensions can override this binding if they want to make PHPCmf use
        // a different queuing backend.
        $this->container->singleton('cmf.queue.connection', function (ContainerImplementation $container) {
            $queue = new SyncQueue;
        ...
        // option and force the binary to PHPCmf.
        ...
        $this->container->alias('cmf.queue.connection', Queue::class);
    ...
    {
        $this->container->extend('cmf.console.commands', function ($commands, Container $container) {
