...
use Cmf\Extension\Exception\ExtensionBootError;
...
class Extension implements Arrayable
{
    ...
    /**
     * The IDs of all Cmf extensions that this extension depends on.
     *
     * @var string[]
     */
    ...
    /**
     * The IDs of all Cmf extensions that this extension should be booted after
     * if enabled.
     *
     * @var string[]
     */
    ...
    protected static function nameToId($name)
    {
        ...
        $package = str_replace(['cmf-ext-', 'cmf-'], '', $package);
    ...
    /**
     * Get the list of cmf extensions that this extension depends on.
     *
    ...
    public function calculateDependencies($extensionSet)
    {
        ...
        $this->optionalDependencyIds = (new Collection(Arr::get($this->composerJson, 'extra.cmf-extension.optional-dependencies', [])))
            ->map(function ($key) {
                return static::nameToId($key);
            })
            ->toArray();
    ...
    {
        $icon = $this->composerJsonAttribute('extra.cmf-extension.icon');
    ...
    {
        return $this->composerJsonAttribute('extra.cmf-extension.title');
    }
    ...
    /**
     * The IDs of all PHPCmf extensions that this extension depends on.
     *
     * @return array
     */
    ...
    /**
     * The IDs of all PHPCmf extensions that this extension should be booted after
     * if enabled.
     *
     * @return array
     */
    ...
    public function getLinks()
    {
        ...
        return array_merge($links, $this->composerJsonAttribute('extra.cmf-extension.links') ?? []);
    }
