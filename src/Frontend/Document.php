...
/**
 * A view which renders a HTML skeleton for PHPCmf's frontend app.
 */
class Document implements Renderable
{
     ...
     * @var string
     */
    public $appView = 'cmf::frontend.app';
     ...
     * @var string
     */
    public $contentView = 'cmf::frontend.content';
    ...
    /**
     * Other variables to preload into the PHPCmf JS.
     *
     * @var array
     */
    public $payload = [];
