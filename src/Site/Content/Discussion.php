...
class Discussion
{
    ...
    public function __invoke(Document $document, Request $request)
    {
        ...
        $url = function ($newQueryParams) use ($queryParams, $apiDocument) {
            ...
            return $this->url->to('site')->route('discussion', ['id' => $apiDocument->data->attributes->slug]).
        ...
        $document->content = $this->view->make('cmf.site::frontend.content.discussion', compact('apiDocument', 'page', 'hasPrevPage', 'hasNextPage', 'getResource', 'posts', 'url'));
