 ...
 * using one of Laravel's various email drivers throughout PHPCmf.
 *
 * @public
 */
interface DriverInterface
{
     ...
     * values stored in PHPCmf's settings are "valid" as far as a simple
     ...
     * presence of validation problems with the configured mail driver, PHPCmf
     * will fall back to its no-op {@see \Cmf\Mail\NullDriver}.
     */
    ...
    /**
     * Build a mail transport based on PHPCmf's current settings.
     */
