...
class Event implements ExtenderInterface
{
    ...
    /**
     * Add a listener to a domain event dispatched by PHPCmf or a PHPCmf extension.
     *
    ...
    /**
     * Add a subscriber for a set of domain events dispatched by cmf or a PHPCmf extension.
