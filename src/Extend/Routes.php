...
class Routes implements ExtenderInterface
{
     ...
     * or extend one of the PHPCmf Api controllers within \Cmf\Api\Controller.
     *
     * The handler should accept:
     * - \Psr\Http\Message\ServerRequestInterface $request
     * - \Tobscure\JsonApi\Document $document: If it extends one of the PHPCmf Api controllers.
     *
