...
use Cmf\Formatter\Formatter as ActualFormatter;
...
class Formatter implements ExtenderInterface, LifecycleInterface
{
     ...
     * - \Cmf\User\User|null $actor. This argument MUST either be nullable, or omitted entirely.
     *
    ...
    {
        $container->extend('cmf.formatter', function ($formatter, $container) {
