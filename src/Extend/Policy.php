...
class Policy implements ExtenderInterface
{
     ...
     *
     * @param string $policy: ::class attribute of policy class, which must extend Cmf\User\Access\AbstractPolicy
     * @return self
     */
    ...
    {
        $container->extend('cmf.policies', function ($existingPolicies) {
