...
class Model implements ExtenderInterface
{
     ...
     * @param string $related: The ::class attribute of the model, which should extend \Cmf\Database\AbstractModel.
     ...
     *                  like \Cmf\User\User for examples of how relationships should be returned.
     *
     * @return self
     */
