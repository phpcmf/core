...
class ModelVisibility implements ExtenderInterface
{
     ...
     *                           This model must extend from \Cmf\Database\AbstractModel,
     *                           and use \Cmf\Database\ScopeVisibilityTrait.
     */
    public function __construct(string $modelClass)
    {
        ...
        if (class_exists($this->modelClass) && ! is_callable([$modelClass, 'registerVisibilityScoper'])) {
            throw new Exception("Model $modelClass cannot be visibility scoped as it does not use Cmf\Database\ScopeVisibilityTrait.");
        }
    }
