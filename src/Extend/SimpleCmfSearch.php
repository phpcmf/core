...
class SimpleCmfSearch implements ExtenderInterface
{
     ...
     *                               This searcher must extend \Cmf\Search\AbstractSearcher.
     */
     ...
     *                             This gambit must extend \Cmf\Search\AbstractRegexGambit
     * @return self
     */
     ...
     *                             This gambit must implement \Cmf\Search\GambitInterface
     * @return self
     */
     ...
     * - \Cmf\Search\SearchState $search
     * - \Cmf\Query\QueryCriteria $criteria
     *
    ...
    public function extend(Container $container, Extension $extension = null)
    {
        if (! is_null($this->fullTextGambit)) {
            $container->extend('cmf.simple_search.fulltext_gambits', function ($oldFulltextGambits) {
        ...
        $container->extend('cmf.simple_search.gambits', function ($oldGambits) {
        ...
        $container->extend('cmf.simple_search.search_mutators', function ($oldMutators) {
