...
class LanguagePack implements ExtenderInterface, LifecycleInterface
{
    ...
    public function extend(Container $container, Extension $extension = null)
    {
        ...
        $locale = $extension->composerJsonAttribute('extra.cmf-locale.code');
        $title = $extension->composerJsonAttribute('extra.cmf-locale.title');

        if (! isset($locale, $title)) {
            throw new RuntimeException(
                'Language packs must define "extra.cmf-locale.code" and "extra.cmf-locale.title" in composer.json.'
            );
        }
    ...
    {
        $container->make('cmf.locales')->clearCache();
    }
