...
class Filter implements ExtenderInterface
{
    ...
    {
        $container->extend('cmf.filter.filters', function ($originalFilters) {
        ...
        $container->extend('cmf.filter.filter_mutators', function ($originalMutators) {
