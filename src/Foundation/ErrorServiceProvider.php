...
use Cmf\Extension\Exception as ExtensionException;
use Cmf\Foundation\ErrorHandling as Handling;
...
class ErrorServiceProvider extends AbstractServiceProvider
{
    ...
    {
        $this->container->singleton('cmf.error.statuses', function () {
            return [
                // 400 Bad Request
        ...
        $this->container->singleton('cmf.error.classes', function () {
            return [
        ...
        $this->container->singleton('cmf.error.handlers', function () {
            return [
        ...
        $this->container->singleton(Handling\Registry::class, function () {
            return new Handling\Registry(
                $this->container->make('cmf.error.statuses'),
                $this->container->make('cmf.error.classes'),
                $this->container->make('cmf.error.handlers')
            );
        });
