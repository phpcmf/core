...
class Application
{
    ...
    /**
     * The IoC container for the PHPCmf application.
     *
     * @var Container
     */
    private $container;
    ...
    /**
     * The paths for the PHPCmf installation.
     *
     * @var Paths
     */
    protected $paths;
    ...
    /**
     * Create a new PHPCmf application instance.
     *
    ...
    {
        $config = $this->container->make('cmf.config');

        return $config[$key] ?? $default;
    }

    /**
     * Check if PHPCmf is in debug mode.
     *
     * @return bool
     */
    ...
    /**
     * Get the URL to the PHPCmf installation.
     *
     * @param string $path
     * @return string
     */
    ...
    protected function registerBaseBindings()
    {
         ...
         * Use container inside PHPCmf instead.
         */
        ...
        $this->container->instance('cmf', $this);
        $this->container->alias('cmf', self::class);

        $this->container->instance('cmf.paths', $this->paths);
        $this->container->alias('cmf.paths', Paths::class);
    }
