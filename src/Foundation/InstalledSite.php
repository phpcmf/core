...
use Cmf\Admin\AdminServiceProvider;
use Cmf\Api\ApiServiceProvider;
use Cmf\Bus\BusServiceProvider;
use Cmf\Console\ConsoleServiceProvider;
use Cmf\Database\DatabaseServiceProvider;
use Cmf\Discussion\DiscussionServiceProvider;
use Cmf\Extension\ExtensionServiceProvider;
use Cmf\Filesystem\FilesystemServiceProvider;
use Cmf\Filter\FilterServiceProvider;
use Cmf\Formatter\FormatterServiceProvider;
use Cmf\Frontend\FrontendServiceProvider;
use Cmf\Group\GroupServiceProvider;
use Cmf\Http\HttpServiceProvider;
use Cmf\Locale\LocaleServiceProvider;
use Cmf\Mail\MailServiceProvider;
use Cmf\Notification\NotificationServiceProvider;
use Cmf\Post\PostServiceProvider;
use Cmf\Queue\QueueServiceProvider;
use Cmf\Search\SearchServiceProvider;
use Cmf\Settings\SettingsServiceProvider;
use Cmf\Site\SiteServiceProvider;
use Cmf\Update\UpdateServiceProvider;
use Cmf\User\SessionServiceProvider;
use Cmf\User\UserServiceProvider;
...
class InstalledSite implements SiteInterface
{
    ...
    /**
     * @var \Cmf\Extend\ExtenderInterface[]
     */
    protected $extenders = [];
    ...
    /**
     * @param \Cmf\Extend\ExtenderInterface[] $extenders
    ...
    protected function bootLaravel(): Container
    {
        ...
        $container->instance('cmf.config', $this->config);
        $container->alias('cmf.config', Config::class);
        $container->instance('cmf.debug', $this->config->inDebugMode());
        $container->instance('config', $config = $this->getIlluminateConfig());
        $container->instance('cmf.maintenance.handler', new MaintenanceModeHandler);
