...
export default class StatusWidget extends DashboardWidget {
  ...
  items() {
    ...
    items.add('version-cmf', [<strong>Cmf</strong>, <br />, app.site.attribute('version')], 100);
      ...
      items.add(
        ...
        [
          <span>
            ...
            <LinkButton href="https://phpcmf.cn/discussion/24118" external={true} target="_blank" icon="fas fa-info-circle" />
          </span>,
          <br />,
  ...
  handleClearCache(e) {
    ...
    app
      .request({
        method: 'DELETE',
        url: app.site.attribute('apiUrl') + '/cache',
      })
