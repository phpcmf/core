...
export default class ExtensionData {
   ...
   *
   * @example
   * app.extensionData.for('cmf-tags')
   *
   * cmf/flags -> cmf-flags | acme/extension -> acme-extension
   */
  ...
  /**
   * This function registers your settings with Cmf
   *
   ...
   *
   * .registerSetting({
   *   setting: 'cmf-flags.guidelines_url',
   *   type: 'text', // This will be inputted into the input tag for the setting (text/number/etc)
   *   label: app.translator.trans('cmf-flags.admin.settings.guidelines_url_label')
  ...
  /**
   * This function registers your permission with Cmf
   *
   * @example
   *
   * .registerPermission('permissions', {
   *     icon: 'fas fa-flag',
   *     label: app.translator.trans('cmf-flags.admin.permissions.view_flags_label'),
