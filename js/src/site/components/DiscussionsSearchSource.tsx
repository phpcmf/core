...
export default class DiscussionsSearchSource implements SearchSource {
  ...
  view(query: string): Array<Mithril.Vnode> {
    ...
    return [
      <li className="Dropdown-header">{app.translator.trans('core.site.search.discussions_heading')}</li>,
      <li>
        <LinkButton icon="fas fa-search" href={app.route('index', { q: query })}>
          {app.translator.trans('core.site.search.all_discussions_button', { query })}
        </LinkButton>
      </li>,
      ...results,
    ];
