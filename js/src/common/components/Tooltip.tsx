...
export interface TooltipAttrs extends Mithril.CommonAttributes<TooltipAttrs, Tooltip> {
   ...
   * tooltip library. Be prepared for this to break in PHPCmf stable.
   *
   * Default: `false`.
   *
   * @deprecated
   ...
   * library. Be prepared for this to break in PHPCmf stable.
   *
   * Default: `0`.
   *
   * @deprecated
 ...
 * PHPCmf. This shouldn't be an issue if you're using this component correctly.
 *
...
export default class Tooltip extends Component<TooltipAttrs> {
  ...
  view(vnode: Mithril.Vnode<TooltipAttrs, this>) {
    ...
    // Throwing an error will prevent the site rendering, but will be better at alerting devs to
    // an issue.
