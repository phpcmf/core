...
export interface IDismissibleOptions {
  /**
   * @deprecated Check specific individual attributes instead. Will be removed in PHPCmf 2.0.
   */
...
export default abstract class Modal<ModalAttrs extends IInternalModalAttrs = IInternalModalAttrs, CustomState = undefined> extends Component<
  ...
  CustomState
> {
  // TODO: [PHPCmf 2.0] remove `isDismissible` static attribute
  /**
  ...
  static get dismissibleOptions(): IDismissibleOptions {
    // If someone sets this to `false`, provide the same behaviour as previous versions of PHPCmf.
  ...
  oninit(vnode: Mithril.Vnode<ModalAttrs, this>) {
    ...
    // TODO: [PHPCmf 2.0] Remove the code below.
    // This code prevents extensions which do not implement all abstract methods of this class from breaking
    // the site frontend. Without it, function calls would would error rather than returning `undefined.`
