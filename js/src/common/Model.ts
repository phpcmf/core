...
import { CmfRequestOptions } from './Application';
...
export default abstract class Model {
  ...
  save(
    ...
    options: Omit<CmfRequestOptions<ApiPayloadSingle>, 'url'> & { meta?: MetaInformation } = {}
   ...
   */
  delete(body: CmfRequestOptions<void>['body'] = {}, options: Omit<CmfRequestOptions<void>, 'url'> = {}): Promise<void> {
