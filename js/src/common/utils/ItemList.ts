...
export default class ItemList<T> {
  ...
  // TODO: [PHPCmf 2.0] Remove `.items` getter.
  /**
  ...
  // TODO: [PHPCmf 2.0] Remove deprecated `.replace()` method.
  /**
   ...
   * methods to replace items and their priorities. This method will be removed in PHPCmf 2.0.
   *
   ...
   *
   * @see https://github.com/phpcmf/core/issues/3030
   */
